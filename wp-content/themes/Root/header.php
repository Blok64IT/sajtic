...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php get_template_directory_uri()?>wp-content/themes/Root/assets/images/favicon.png" type="image/png" sizes="16x16">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri()?>/assets/css/animate.css"> <!-- Resource style -->
